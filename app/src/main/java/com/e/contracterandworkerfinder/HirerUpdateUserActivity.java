...
public class HirerUpdateUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listCall.enqueue(new Callback<UserModel>() {
            ...
            public void onFailure(Call<UserModel> call, Throwable t) {
                Toast.makeText(HirerUpdateUserActivity.this, "Error" + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
...
//                                startActivity(intent);
        ...
        btnbackbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.start();
                Intent intent=new Intent(HirerUpdateUserActivity.this, DashboardHireActivity.class);
                startActivity(intent);
            }
        });
    }
        ...
        voidCall.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                if (!response.isSuccessful()) {
                    Toast.makeText(HirerUpdateUserActivity.this, "Code" + response.code(), Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    Toast.makeText(HirerUpdateUserActivity.this, "User Profile Updated Successfully", Toast.LENGTH_SHORT).show();
                    Intent intent = getIntent();
                    finish();
                    startActivity(intent);
                }
            ...
            public void onFailure(Call<Void> call, Throwable t) {
                Toast.makeText(HirerUpdateUserActivity.this, "Error"+t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
